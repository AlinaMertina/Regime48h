            ...
            <div class="container-fluid" style=" width: 400px; margin-top: 100px;">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url("index.php/CT_CRUD/loginAdmin"); ?>" method="POST" >
                            <div class="form-group" style=" justify-content: space-between;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputDefault" type="password" placeholder="Password" class="form-control" style="" name="mdp" value="mertina4">
                                </div>	
                            </div>
