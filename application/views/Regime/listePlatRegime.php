        ...
        <div id="corps"  style="padding:2%;" >
                <p><?php  if(isset( $regime ) ){  if(count($regime)>0) { echo $regime[0]['nomRegime']; } } ?></p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group-append">
                                                <a href="<?php echo base_url("index.php/CT_CRUD/listealimentplate/".$regime[$i]['idPlat']."/0"); ?>" > <button type="button" class="btn btn-primary"  >Voir detaille</button>
                                            </div>
                                        </td>
                                    </tr>
                            <?php }   } ?>
                    ...
                    <div class="container text-center" >
                        <div class="row">
                            <div class="col">
                               <a href="<?php if(isset($num)){ if($num>=5){ $num=$num-5;} echo base_url("index.php/CT_CRUD/listeplateregime/".$idregime."/".$num);   }  ?>" >  <button type="submit" class="btn btn-link"    >Avant</button></a>
                            </div>
                            <div class="col">
                            <?php echo $num=$num+5; ?>
                               <a href="<?php if(isset($num)){  $num=$num+5; echo base_url("index.php/CT_CRUD/listeplateregime/".$idregime."/".$num);   }  ?>" >  <button type="submit" class="btn btn-link"  > Suivant</button></a>
                            </div>
                        </div>
                    </div>
        <div>
