                ...
                <table width="500px" class="table" >
                    ...
                    <tbody>  
                        ...
                        <tr>
                            ...
                            <form action="<?php echo base_url("index.php/CT_Client/detailleRegimeP"); ?>" method="get" >
                                <td>
                            ...
                            <td>
                                <a href="<?php echo base_url("index.php/CT_CRUD/exportP/").$regime[$i]['idRegime']; ?>" > <button type="button" class="btn btn-link">Export</button><a>
                            </td>
