        ...
        <div id="corps"  style="padding:2%;" >
                <p>Regime Alimentaire</p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group-append">
                                                ...
                                                <a href="<?php echo base_url("index.php/CT_CRUD/listeplateregime/").$regime[$i]['idRegime']."/0"; ?>" > <button type="button" class="btn btn-primary"  >Voir detaille</button>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="input-group-append">
                                            
                                                <a href="<?php echo base_url("index.php/CT_Client/setsuivitA/")."?idregime=".$regime[$i]['idRegime']; ?>" > <button type="button" class="btn btn-outline-success"  >Suivre</button>
                                            </div>
                                        </td>
                    ...
                    <div class="container text-center" >
                        <div class="row">
                            <div class="col">
                               <a href="<?php if(isset($num)){ if($num>=5){ $num=$num-5;} echo base_url("index.php/CT_CRUD/listeregimeA/".$num);   }  ?>" >  <button type="submit" class="btn btn-link"    >Avant</button></a>
                            </div>
                            <div class="col">
                               <a href="<?php if(isset($num)){  $num=$num+5; echo base_url("index.php/CT_CRUD/listeregimeA/".$num);   }  ?>" >  <button type="submit" class="btn btn-link"  > Suivant</button></a>
                            </div>
                        </div>
                    </div>
        <div>
